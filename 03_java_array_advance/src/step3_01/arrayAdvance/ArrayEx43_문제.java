...
public class ArrayEx43_문제 {
	...
	public static void main(String[] args) {
		...
		final int SIZE = 7;	 //게임판 한줄 칸수 선언
		final int PLAYER = 2; //플레이어 표시
		final int BALL = 3; // 공 표시
		final int GOAL = 7; // 목표점 표시
		final int WALL = 9; // 벽 표시
		
		int[][] map = new int[SIZE][SIZE]; //게임판 만들기
